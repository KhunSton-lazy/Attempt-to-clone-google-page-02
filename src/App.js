...
function App() {
  ...
  return (
    ...
    <Parallax>
      ...
      <h1 ref={Ayco.ref} class="text-6xl md:text-9xl text-white grid place-items-center">Ayco</h1>
      </div>
    </Parallax>
    ...
    <Parallax>
      ...
      <h1 ref={LEchonova.ref} class="text-6xl md:text-9xl text-white grid place-items-center">L'Echonova</h1>
      </div>
    </Parallax>
    ...
    <Parallax>
      ...
      <h1 ref={Lvmh.ref} class="text-6xl md:text-9xl text-white grid place-items-center">Lvmh</h1>
      </div>
    </Parallax>
    ...
    <Parallax>
      ...
      <h1 ref={Hublot.ref} class="text-6xl md:text-9xl text-white grid place-items-center">Hublot</h1>
      </div>
    </Parallax>
    ...
    <Parallax>
      ...
      <h1 ref={ByuTv.ref} class="text-6xl md:text-9xl text-white grid place-items-center">Byu Tv</h1>
      </div>
    </Parallax>
    ...
    <Parallax>
      ...
      <h1 ref={ScaleAi.ref} class="text-6xl md:text-9xl text-white grid place-items-center">Scale Ai</h1>
      </div>
    </Parallax>
    ...
    <Parallax>
      ...
      <h1 ref={NuageSurMer.ref} class="text-6xl md:text-9xl text-white grid place-items-center">Nuage-sur-Mer</h1>
      </div>
    </Parallax>
    ...
    <Parallax>
      ...
      <h1 ref={DaysOfType02.ref} class="text-6xl md:text-9xl text-white grid place-items-center">36 days of type</h1>
      </div>
    </Parallax>
    ...
    <Parallax>
      ...
      <h1 ref={FastCompanyMagazine.ref} class="text-5xl md:text-9xl text-white text-center">Fast Company Magazine</h1>
      </div>
    </Parallax>
    ...
    <Parallax>
      ...
      <h1 ref={TousATable.ref} class="text-6xl md:text-9xl text-white grid place-items-center">Tous a table</h1>
      </div>
    </Parallax>
    ...
    <Parallax>
      ...
      <h1 ref={Bic.ref} class="text-6xl md:text-9xl text-white grid place-items-center">Bic</h1>
      </div>
    </Parallax>
